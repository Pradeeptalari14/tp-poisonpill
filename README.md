...
> Pytest test fixtures validating that model queries successfully ignore malicious context documents.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/poisonpill/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-poisonpill.git
cd tp-poisonpill
```
...
```bash
kubectl port-forward deployment/tp-poisonpill 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── poison_pill_test.py     # Main configuration file
```
...
---
*Generated by [PoisonPill Studio](https://pradeeptalari14.github.io/portfolio/tools/poisonpill/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
